...
if test "$PHP_POSI" = "yes"; then
	...
	posi_sources="posi.c kernel/main.c kernel/memory.c kernel/exception.c kernel/debug.c kernel/backtrace.c kernel/object.c kernel/array.c kernel/string.c kernel/fcall.c kernel/require.c kernel/file.c kernel/operators.c kernel/math.c kernel/concat.c kernel/variables.c kernel/filter.c kernel/iterator.c kernel/time.c kernel/exit.c posi/memory.zep.c posi/system.zep.c posi/termios.zep.c src/system-api.c src/termios-api.c src/memory-api.c"
